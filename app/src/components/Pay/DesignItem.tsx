  ...
  return (
    <div className="flex flex-col gap-4 bg-slate-300 px-8 py-6 rounded-lg h-full w-full md:h-86 md:w-1/3">
      <div className="flex flex-col">
        ...
        <button onClick={() => setOpen(!open)} className="btn btn-primary normal-case text-md text-white font-bold py-2 px-4 rounded">
          Donate To This Project
        </button>
        {open ? <PopupModal amount={10} designTitle={designTitle} open={open} setOpen={setOpen} /> : null}
      </div>
